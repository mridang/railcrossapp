...
const protection_service_1 = __importDefault(require("../../src/services/railcross/protection.service"));
describe('protection.service test', () => {
    test('that branches get protected"', async () => {
        ...
        expect(await protectionService.toggleProtection('mridang/testing', 0, true)).toMatchObject({
        ...
        expect(await protectionService.toggleProtection('mridang/testing', 0, false)).toMatchObject({
            url: 'https://api.github.com/repos/mridang/testing/branches/master/protection',
            required_pull_request_reviews: {
                url: 'https://api.github.com/repos/mridang/testing/branches/master/protection/required_pull_request_reviews',
                dismiss_stale_reviews: false,
