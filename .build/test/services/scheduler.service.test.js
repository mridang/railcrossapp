...
const scheduler_service_1 = __importDefault(require("../../src/services/railcross/scheduler.service"));
describe('scheduler.service test', () => {
    test('that schedules are added"', async () => {
        const schedulerService = new scheduler_service_1.default(new client_scheduler_1.SchedulerClient({
