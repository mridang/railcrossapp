...
let WebhookController = class WebhookController {
    ...
    async handleWebhook(request) {
        ...
        if (id !== null && id !== undefined) {
            ...
            if (name !== null && name !== undefined) {
                ...
                if (signature !== null && signature !== undefined) {
                    ...
                    if (payload !== null) {
                        ...
                        throw new common_1.BadRequestException('Missing webhook request body');
                    }
                }
                else {
                    throw new common_1.BadRequestException('Missing x-github-signature header');
                }
            }
            else {
            ...
            throw new common_1.BadRequestException('Missing x-github-delivery header');
        }
    }
};
